...
func NewKeeper(cdc *codec.Codec, storeKey sdk.StoreKey, paramspace params.Subspace, accountKeeper auth.AccountKeeper, bankKeeper bank.Keeper, router sdk.Router, queryGasLimit uint64) Keeper {
